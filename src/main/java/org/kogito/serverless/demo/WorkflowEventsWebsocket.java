...
public class WorkflowEventsWebsocket {
    ...
    Flowable<String> workflowInstancesEvents;
    //Publisher<JsonNode> workflowInstancesEvents;

    private static final Logger LOGGER = Logger.getLogger(WorkflowEventsWebsocket.class);
    ...
    public void subscribe() {
        subscription = workflowInstancesEvents.subscribe(event -> sessions.forEach(session -> write(session, event)));
    }
